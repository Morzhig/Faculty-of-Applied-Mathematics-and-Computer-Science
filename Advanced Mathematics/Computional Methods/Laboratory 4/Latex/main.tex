...
Для применения к нашему интегралу $$I = \int\limits_1^3 \dfrac{\ln(\sin^2x + 3)}{x^2+2x-1}dx $$
правила Рунге программно зададим подынтегральную функцию \(f(x)=\dfrac{\ln(\sin^2x + 3)}{x^2+2x-1}\).
...
\PY{n}{a}\PY{p}{,} \PY{n}{b}\PY{p}{ }\PY{o}{=} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{ }
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{mean\PYZus{}rect}\PY{p}{(}\PY{n}{a}\PY{p}{,} \PY{n}{b}\PY{p}{,} \PY{n}{f}\PY{p}{,} \PY{n}{h}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{N}\PY{p}{)}\PY{p}{:}
        \PY{n}{I} \PY{o}{+}\PY{o}{=} \PY{n}{f}\PY{p}{(}\PY{n}{a} \PY{o}{+} \PY{p}{(}\PY{n}{k} \PY{o}{+} \PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{2} \PY{o}{*} \PY{n}{h}\PY{p}{)}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{m} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{runge\PYZus{}rule}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{a}\PY{p}{,} \PY{n}{b}\PY{p}{,} \PY{n}{mean\PYZus{}rect}\PY{p}{,} \PY{n}{f}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{runge\PYZus{}rule}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{a}\PY{p}{,} \PY{n}{b}\PY{p}{,} \PY{n}{trap}\PY{p}{,} \PY{n}{f}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}\PY{p}{)}

\PY{n}{h1} \PY{o}{=} \PY{n}{runge\PYZus{}rule}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{a}\PY{p}{,} \PY{n}{b}\PY{p}{,} \PY{n}{mean\PYZus{}rect}\PY{p}{,} \PY{n}{f}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}

\PY{n}{df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{n}{columns} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Количество узлов}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Средние прямоугольники}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
...
\PY{n}{df}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Средние прямоугольники}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{runge\PYZus{}rule}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{a}\PY{p}{,} \PY{n}{b}\PY{p}{,} \PY{n}{mean\PYZus{}rect}\PY{p}{,} \PY{n}{f}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}

\PY{n}{df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{concat}\PY{p}{(}\PY{p}{[}\PY{n}{df}\PY{p}{,} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{n}{runge\PYZus{}rule}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{a}\PY{p}{,} \PY{n}{b}\PY{p}{,} \PY{n}{trap}\PY{p}{,} \PY{n}{f}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,} \PY{n}{columns}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Трапеции}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{verify\PYZus{}integrity}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{o}{.}\PY{n}{fillna}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{df}
\end{Verbatim}
\end{tcolorbox}
...
уравнения \[f(x)=0,\] которое будем решать методом Ньютона.
    ...
    Вспомним первую лабораторную работу и рассмотрим теорему о сходимости метода Ньютона. \begin{theorem}[о сходимости метода Ньютона]
...
\[f'(x)>0, \ x \in [0, +\infty],\] следовательно, наша исходная функция является монотонно возрастающей на нашем множестве.
...
Опираясь на заданее 3, будем использовать составную формулу трапеций,
поскольку этот метод сошелся быстрее в рассматриваемом случае, для
\(\epsilon = 10^{-4}\).
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{f}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{runge\PYZus{}rule}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{trap}\PY{p}{,} \PY{n}{g}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{l+m+mi}{5}
\end{Verbatim}
\end{tcolorbox}
...
Выберем \(x_0\) из полученного отрезка, например, \(x_0 = 2.4\) и перейдем к проверке
условий теоремы
...
\end{tcolorbox}
    ...
    Таким образом, мы смогли достичь нужной степени точности за $3$
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{f}\PY{p}{(}\PY{l+m+mf}{2.415610}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
2.79332797781251e-07
\end{Verbatim}
\end{tcolorbox}
        
    Получаем, что $$f(2.415610) \approx 2.79 \cdot 10^{-7} < 10^{-4} = \epsilon,$$ Следовательно, полученное решение действительно является решением уравнения при
